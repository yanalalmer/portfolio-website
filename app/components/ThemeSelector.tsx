...
export const ThemeSelector = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={togglePanel}
        className="fixed top-8 right-8 p-4 bg-bgOffset text-bg rounded-full font-medium hover:opacity-80 transition-all duration-300 ease-in-out flex items-center gap-2"
